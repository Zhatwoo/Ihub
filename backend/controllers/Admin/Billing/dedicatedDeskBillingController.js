// Dedicated Desk Billing Controller
// Handles fetching and updating billing details for dedicated desk tenants
...
export const getDedicatedDeskBillingDetails = async (req, res) => {
  try {
    ...
    console.error('❌ Get dedicated desk billing details error:', error);
    res.status(500).json({
      success: false,
...
export const updateDedicatedDeskBillingDetails = async (req, res) => {
  try {
    ...
    console.error('❌ Update dedicated desk billing details error:', error);
    res.status(500).json({
      success: false,
      error: 'Internal Server Error',
