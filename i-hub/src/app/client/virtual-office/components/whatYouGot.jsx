  ...
  return (
    <section ref={sectionRef} className="w-full bg-[#F8FAFC] min-h-[70vh] relative">
      ...
      <motion.div 
        ...
        className="w-full flex items-center justify-center pt-8 sm:pt-12 md:pt-16 pb-4 sm:pb-6 md:pb-8"
      >
      ...
      {/* Cards Container */}
      <div ref={cardsRef} className="w-full flex justify-center items-stretch gap-4 sm:gap-6 flex-wrap px-4 sm:px-6 md:px-8 py-4 sm:py-6 md:py-8 pb-16 sm:pb-20 md:pb-22 relative z-10">
        {/* Card 1: Your Address */}
        <motion.div 
          ...
          className="w-full max-w-[322px] sm:w-[322px] bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden flex flex-col relative z-10 transition-all duration-300 ease-in-out hover:shadow-2xl cursor-pointer"
        >
          {/* Top Section - Dark Teal */}
          <div className="w-full h-[180px] sm:h-[200px] md:h-[230px] bg-[#0F766E] flex items-center justify-center p-4 sm:p-6 relative">
            <Image
        ...
        <motion.div 
          ...
          className="w-full max-w-[322px] sm:w-[322px] bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden flex flex-col relative z-10 transition-all duration-300 ease-in-out cursor-pointer"
        >
          {/* Top Section - Light Beige/Orange */}
          <div className="w-full h-[180px] sm:h-[200px] md:h-[230px] bg-[#F4A460] flex items-center justify-center p-4 sm:p-6 relative">
            <Image
        ...
        >
          ...
          <div className="w-full h-[180px] sm:h-[200px] md:h-[230px] bg-[#87CEEB] flex items-center justify-center p-4 sm:p-6 relative">
            <Image
        ...
        >
          ...
          <div className="w-full h-[180px] sm:h-[200px] md:h-[230px] bg-[#4169E1] flex items-center justify-center p-4 sm:p-6 relative">
            <Image
