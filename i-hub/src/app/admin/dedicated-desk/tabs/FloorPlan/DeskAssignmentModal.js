      ...
      >
        <div className="flex justify-between items-center mb-4 sm:mb-6 pb-3 sm:pb-4 border-b-2 border-gray-100">
          ...
          <div className="flex items-center gap-2 relative">
                ...
                {showDropdown && (
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-200 z-20 overflow-hidden">
                      <div className="py-2">
                        <button onClick={handleEdit} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-slate-800 hover:bg-teal-50 transition-colors group">
                        ...
                        <button onClick={handleMove} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-slate-800 hover:bg-teal-50 transition-colors group">
                          <svg className="w-5 h-5 text-gray-400 group-hover:text-teal-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button onClick={handleDelete} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors group">
            ...
            <button onClick={onClose} disabled={loading} className="w-8 h-8 sm:w-9 sm:h-9 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 text-lg sm:text-xl hover:bg-gray-200 hover:text-slate-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed">×</button>
          </div>
        </div>
        ...
        {isViewMode ? (
          <div className="space-y-4 sm:space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-slate-800 mb-2 font-semibold text-xs sm:text-sm">Desk</label>
                <div className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 border-2 border-gray-300 rounded-xl text-sm sm:text-base text-slate-900 bg-gray-300 cursor-not-allowed">{deskTag}</div>
              </div>
              <div>
                <label className="block text-slate-800 mb-2 font-semibold text-xs sm:text-sm">Name</label>
                <div className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 border-2 border-gray-200 rounded-xl text-sm sm:text-base text-slate-900 bg-gray-50">{existingAssignment.name}</div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-slate-800 mb-2 font-semibold text-xs sm:text-sm">Type of Occupant</label>
                <div className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 border-2 border-gray-200 rounded-xl text-sm sm:text-base text-slate-900 bg-gray-50">{existingAssignment.type}</div>
              </div>
              <div>
                <label className="block text-slate-800 mb-2 font-semibold text-xs sm:text-sm">Contact Number</label>
                <div className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 border-2 border-gray-200 rounded-xl text-sm sm:text-base text-slate-900 bg-gray-50">{existingAssignment.contactNumber || "N/A"}</div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
          ...
          <form id="desk-assignment-form" onSubmit={handleUpdateAssignment} className="space-y-4 sm:space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-slate-800 mb-2 font-semibold text-xs sm:text-sm">Desk <span className="text-red-500">*</span></label>
                <div className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 border-2 border-gray-300 rounded-xl text-sm sm:text-base text-slate-900 bg-gray-300 cursor-not-allowed">{deskTag}</div>
              </div>
              <div>
                <label className="block text-slate-800 mb-2 font-semibold text-xs sm:text-sm">Name <span className="text-red-500">*</span></label>
                <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Enter occupant name" required disabled={loading} className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 border-2 border-gray-200 rounded-xl text-sm sm:text-base text-slate-900 bg-gray-50 focus:outline-none focus:border-teal-600 focus:bg-white focus:ring-4 focus:ring-teal-600/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
              ...
              <div>
                ...
                <input type="tel" name="contactNumber" value={formData.contactNumber} onChange={handleChange} placeholder="Enter contact number" required disabled={loading} className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 border-2 border-gray-200 rounded-xl text-sm sm:text-base text-slate-900 bg-gray-50 focus:outline-none focus:border-teal-600 focus:bg-white focus:ring-4 focus:ring-teal-600/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
      ...
      {toast.show && (
        <div className="fixed top-6 right-6 z-[10000] animate-slideInRight">
          <div className={`px-5 py-4 rounded-xl shadow-2xl flex items-center gap-3 min-w-[300px] max-w-md ${
            ...
            <button onClick={() => setToast({ show: false, message: "", type: "error" })} className="ml-2 text-white/80 hover:text-white text-xl font-bold transition-colors flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full hover:bg-white/20">×</button>
          </div>
        </div>
      )}
