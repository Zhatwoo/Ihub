                ...
                <div className="flex gap-3">
                  ...
                  {bookingStep < 3 ? (
                    ...
                    <button
                      ...
                      className="flex-1 py-2.5 px-6 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
                      style={{ backgroundColor: '#0F766E' }}
